...
if __name__ == "__main__":
    ...
    save_dir = f"{hparams['feature_function_name']}_{hparams['tls_subset']}_{hparams['save_dir']}"
    ckpt_path = f"{hparams['feature_function_name']}_{hparams['tls_subset']}_{hparams['save_dir']}/{hparams['ckpt_path']}"
