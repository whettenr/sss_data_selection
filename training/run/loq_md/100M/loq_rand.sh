#!/bin/bash
#SBATCH --job-name=lmd_rand   # nom du job
#SBATCH -C a100
...
#SBATCH --output=/lustre/fsn1/projects/rech/nkp/uaj64gk/log/loqrand_100M_%j.log  # log file
...
feat_name=random
tls_subset=medium
output_folder=results/no_str_loq_100M_${tls_subset}_${feat_name}_50
