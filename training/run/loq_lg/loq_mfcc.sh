#!/bin/bash
#SBATCH --job-name=QB_MFCCs   # nom du job
#SBATCH -C a100
...
#SBATCH --output=/lustre/fsn1/projects/rech/nkp/uaj64gk/log/QB_MFCCs_330M_%j.log  # log file
...
feat_name=mfcc
tls_subset=large
output_folder=results/loq_330M_${tls_subset}_${feat_name}_50_fp16
