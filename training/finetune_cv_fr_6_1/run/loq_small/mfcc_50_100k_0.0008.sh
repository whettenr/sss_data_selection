...
save_name=mfcc_50
step=100
hub=/lustre/fswork/projects/rech/nkp/uaj64gk/dataselection/results/loq_small_${save_name}_lr_0.0008/steps/CKPT+step_${step}000

output_folder=results/loq_${save_name}_0.0008/step_${step}k_bpe
tls_subset=small
