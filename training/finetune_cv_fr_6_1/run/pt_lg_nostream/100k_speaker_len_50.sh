...
save_name=speaker_len_50
step=100
hub=/lustre/fswork/projects/rech/nkp/uaj64gk/dataselection/results/no_str_loq_100M_large_${save_name}/steps/CKPT+step_${step}000
...
output_folder=results/no_str_loq_100M_${save_name}_${tls_subset}_ptlg/step_${step}k_bpe
