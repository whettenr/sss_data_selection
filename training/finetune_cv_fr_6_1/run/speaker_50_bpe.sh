...
hub=/lustre/fswork/projects/rech/nkp/uaj64gk/dataselection/results/lebench_sm_${save_name}/steps/CKPT+step_50000
...
output_folder=results/${save_name}_bpe/step_50k
batch_size=64
test_batch_size=24
