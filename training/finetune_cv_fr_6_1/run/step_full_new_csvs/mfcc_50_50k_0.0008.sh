...
step=50
hub=/lustre/fswork/projects/rech/nkp/uaj64gk/dataselection/results/lebench_sm_${save_name}_lr_0.0008/steps/CKPT+step_${step}000
...
output_folder=results/${save_name}_0.0008/step_${step}k_newcsv
batch_size=64
test_batch_size=24
