...
#SBATCH --job-name=qLEN200k
#SBATCH -C a100
#SBATCH --account=nkp@a100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=16
#SBATCH --time=6:00:00          # temps d'exécution maximum demande (HH:MM:SS) 
...
save_name=length_50
step=200
hub=/lustre/fswork/projects/rech/nkp/uaj64gk/dataselection/results/no_str_loq_100M_medium_${save_name}/steps/CKPT+step_${step}000
...
output_folder=results/no_str_loq_100M_${save_name}_${tls_subset}/step_${step}k_bpe
