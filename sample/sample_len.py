...
# csv file path
fp = "/local_disk/apollon/rwhetten/loquacious_medium_train.csv"
# load in df
df = pd.read_csv(fp)
# sort
...
selected_df.to_csv("/local_disk/apollon/rwhetten/sss_data_selection/sample/csvs/loq_medium/length_0.5.csv", index=False)
